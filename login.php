  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin">
        <h2 class="form-signin-heading">Παρακαλώ Συνδεθείτε</h2>
        <label for="inputEmail" class="sr-only">Ηλεκτρονική Διεύθυνση</label>
        ...
        <div class="checkbox">
          <label>
            <input value="remember-me" type="checkbox"> Να με θυμάσαι
          </label>
        </div>
