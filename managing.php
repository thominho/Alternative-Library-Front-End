...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="starter-template">
		<!--loop to appear all the thinks we have for the cart -->
        <h2 align="left">Ιστορικό Δανεισμών</h2>
        <div align="left" class="row">
		<div class="col-xs-4">Eικόνα</div>
		<div class="col-xs-4">Όνομα Βιβλίου: <a>Hμερομηνία</a></div>
		<div class="col-xs-4">Τιμή: <a>Hμερομηνία</a></div>
		<div class="col-xs-4">Όνομα Βιβλιοθήκης: <a>Hμερομηνία</a></div>
		<div class="col-xs-4">Ημέρα που λήγει ο δανεισμός: <a>Hμερομηνία</a> </div>
		<div class="col-xs-4">Aνανέωση Δανεισμού(μορφή Ημ.:12-03-2016)
		<input id="inputText" class="form-control" placeholder="Hμερομηνία" required="" type="text"> 
		<button class="btn btn-lg btn-primary btn-block" type="submit">Aνανέωση</button> 
		</div>
		</div>
      </div>
