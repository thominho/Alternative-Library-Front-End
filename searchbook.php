...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="starter-template">
			<p align="left" ><h2>Aναζήτηση Βιβλίων μέσω Βιβλιοθήκης<h2></p>
			<div>
		  	<a class="form-inline pull-xs-right" align="left">
            <input class="form-control" placeholder="Βιβλιοθήκη" type="text">
            </a>
      ...
      <div class="row">
        <div class="col-md-8">
		  Tίτλος:
          <div class="row">
            <div class="col-md-6">Διαθεσιμότητα:</div>
            <div class="col-md-6">Συγγραφέας:</div>
			<div class="col-md-12">Έτος:</div>
          </div>
        </div>
        <div class="col-md-4">Βιβλιοθήκη:
		    <div class="row">
            <div class="col-md-12">Διεύθυνση:</div>
            <div class="col-md-12">Επικοινωνία:</div>
          </div>
		</div>
      </div>
